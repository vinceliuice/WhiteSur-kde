...
Item {
    ...
    property alias cfg_spinboxHorizontalPercentage: spinboxHorizontalPercentage.value
    ...
    QtLayouts.ColumnLayout {
        ...
        QtLayouts.RowLayout {
            ...
            QtControls.SpinBox {
                id: spinboxHorizontalPercentage
                decimals: 0
                minimumValue: 30;
                maximumValue: 100;
                value: 90;
            ...
            QtControls.Label {
                text: i18n("% Height percentage of horizontal panel")
            }
